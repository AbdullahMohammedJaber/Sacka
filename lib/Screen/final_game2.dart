...
class FinalGame2 extends StatefulWidget {
  @override
  State<FinalGame2> createState() => _FinalGame2State();
}

class _FinalGame2State extends State<FinalGame2> {
                      ...
                      children: [
                        RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            SackaCubit.get(context).names.clear();
